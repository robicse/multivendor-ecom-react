...
const SellerSignup = () => {
  ...
  const handleFormSubmit = async (values) => {
    console.log(values)
  //  const result = await customerResistration(values)
  //   if(result){
  //     Router.push('/orders')
  //   }
  };
    ...
    <Wrapper elevation={3} passwordVisibility={passwordVisibility}>
      <form onSubmit={handleSubmit}>
        ...
        <BazarTextField
          ...
          label="Logo"
          accept=".png, .jpg, .jpeg"
          // placeholder="5th Floor,BBTOA Building, 9 No South, Mirpur Rd,Dhaka"
